...
class CharacterEditorState extends MusicBeatState
{
	...
	function addSettingsUI() {
		...
		var templateCharacter:FlxButton = new FlxButton(140, 50, "Load Template", function()
		{
			...
			for (character in characters)
			{
				...
				character.isInfected = parsedJson.isInfected;
	...
	var isInfectedCheckBox:FlxUICheckBox;
	...
	function addCharacterUI() {
		...
		isInfectedCheckBox = new FlxUICheckBox(healthIconInputText.x + 110, healthIconInputText.y, null, null, "Infected Character?", 70);
		isInfectedCheckBox.checked = char.isInfected;
		isInfectedCheckBox.box.color = 0xFF6d093f;
		isInfectedCheckBox.mark.color = 0xFFde173e;
		isInfectedCheckBox.getLabel().color = 0xFFFFFFFF;
		if(char.isInfected) isInfectedCheckBox.checked = !isInfectedCheckBox.checked;
		isInfectedCheckBox.callback = function() {
			char.isInfected = !char.isInfected;
		};
		...
		tab_group.add(isInfectedCheckBox);
