...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Add Third Player', "Value 1: Set The new Character name\n and put the new X and Y variables\nEXAMPLE: ['pico', 300, 400]\nValue 2: Set the Character Type: Avaiables: 'Player', 'Enemie'.\nPelonchas. no hace falta que cambies nada aqui xD ya q yo lo hare"],
