...
/**
     * TAKED FROM: https://haxeflixel.com/demos/Filters/

    - Grain Effect, for looks simlilar to Left 4 Dead, Grain Filter Effect
      hmmmm, more like to Cinema Movies, zombies, horror, yah!
**/
class Grain extends FlxShader
{
	@:glFragmentSource('
		...
		*/
		...
		const float grainamount = 0.06; //grain amount
		bool colored = false; //colored noise?
		float coloramount = 0.6;
		float grainsize = 1.62; //grain particle size (1.5 - 2.5)
